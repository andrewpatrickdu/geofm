...
###############################################################################
# Functions and classes to remove timm dependencies
###############################################################################

# Custom implementation of to_2tuple
def to_2tuple(x):
    return (x, x) if isinstance(x, int) else x

# Define Attention submodule
class Attention(nn.Module):
    def __init__(self, dim, num_heads, qkv_bias=True, attn_drop=0.0, proj_drop=0.0):
        ...
        self.q_norm = nn.Identity()  # Placeholder for optional normalization
        self.k_norm = nn.Identity()  # Placeholder for optional normalization
...
class Mlp(nn.Module):
    def __init__(self, dim, hidden_dim, drop=0.0):
        ...
        self.norm = nn.Identity()  # Placeholder for optional normalization
...
# Custom implementation of Block
class Block(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4.0, qkv_bias=True, norm_layer=nn.LayerNorm):
        ...
        self.ls1 = nn.Identity()  # Placeholder for layer scaling
        self.drop_path1 = nn.Identity()  # Placeholder for stochastic depth

        self.norm2 = norm_layer(dim, eps=1e-5)
        self.mlp = Mlp(dim, int(dim * mlp_ratio))
        self.ls2 = nn.Identity()  # Placeholder for layer scaling
        self.drop_path2 = nn.Identity()  # Placeholder for stochastic depth
...
class PrithviViT(nn.Module):
    ...
    def __init__(self,
        ...
        # ADDED: Expose patch_embed and sequence length for convenience
        self.sequence_length = self.patch_embed.num_patches + 1 
    ...
    def forward(
        ...
        x, mask, ids_restore = self.random_masking(x, mask_ratio, noise) # ADDED 'noise' input
...
class PrithviMAE(nn.Module):
    ...
    def __init__(self,
        ...
        self.sequence_length = self.encoder.patch_embed.num_patches + 1        
    ...
    def forward(
        ...
        latent, mask, ids_restore = self.encoder(pixel_values, noise, temporal_coords, location_coords, mask_ratio) # ADDED 'noise' as input
